...
\begin{document}
    ...
    Perhaps the most important aspect of my proposal is to include a form of
    version control in the backup process. I have recently been heavily
    involved in web applications development, and have therefore been
    ...
    If a conventional backup system is scheduled to mirror a directory tree
    every evening, and an administrator mistakenly removes a
