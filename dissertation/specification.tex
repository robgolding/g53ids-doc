...
The ``home'' screen of the web interface will present the user with a dashboard
interface, showing important system statistics, and recently occurring events.
