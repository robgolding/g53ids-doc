...
Though the API is built atop a REST (Representational State Transfer)
interface, the core networking functionality (i.e. file synchronisation) of the
Ubuntu One client is based on the Twisted framework\cite{UbuntuOne-servers}.
