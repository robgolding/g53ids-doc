...
\emph{mt}) then Amanda can use it\cite{AMANDA-about}.
...
standard formats\cite{Bacula-about}.
...
facilitate instant access to archived files through the
...
continuous, scheduled or manual backups. A Linux client is not
available\cite{Mozy}.

Once a file has been backed up, all changes in that file are reflected in the
archives. Users can restore past versions of a file up to 30 days
past\cite{Mozy}.
