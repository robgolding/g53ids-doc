...
Ultimately, the software fulfils all the requirements which are detailed in the
specification, and proves to be an effective method of protecting data. Given
